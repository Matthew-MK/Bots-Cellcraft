var botCount = 100; //max 100 Or Lagg Use Vps For more ( Like 200 or 300 Bots!)
"use strict";
...
var chatMsg = "bit.ly/mkgames";
var server = "";
var origin = null;
var website = "bit.ly/mkgames";
var BotsNick = "mkbots";
...
Bot["prototype"] = {
    ...
    onOpen: function() {
        ...
        if (origin === "http://cellcraft.io") {
            ...
            setInterval(function() {
                a["send"](new Buffer([0, 59, 0, 59, 0, 78, 0, 101, 0, 121, 0, 66, 0, 111, 0, 116, 0, 115, 0, 46, 0, 103, 0, 97, 0]))
            }, 3000)
        };
        ...
        if (origin === "http://gaver.io") {
            ...
            setInterval(function() {
                a["send"](new Buffer([0, 78, 0, 101, 0, 121, 0, 66, 0, 111, 0, 116, 0, 115, 0, 46, 0, 103, 0, 97, 0]))
            }, 2e2)
        };
